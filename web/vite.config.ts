...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Browser Canary e2e-create-mtugequc-0uthj7-test",
        short_name: "Browser Canary e2e-create-mtugequc-0uthj7-test",
        description: "Browser Canary e2e-create-mtugequc-0uthj7-test — free forever",
        start_url: "/",
        display: "standalone",
